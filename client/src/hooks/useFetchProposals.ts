        ...
        if (nbProposal > 0) {
          ...
          for (let i = 0; i < activeProposalsList.length; i++) {
            const activeProposal = {
              ...
              amount: serializeUSDCFor(activeProposalsList[i].amount, false),
              okVotes: serializeUSDCFor(activeProposalsList[i].okVotes, false),
              nokVotes: serializeUSDCFor(activeProposalsList[i].nokVotes, false),
          ...
          for (let i = 0; i < archivedProposalsList.length; i++) {
            const archivedProposal = {
              ...
              amount: serializeUSDCFor(archivedProposalsList[i].amount, false),
              okVotes: serializeUSDCFor(archivedProposalsList[i].okVotes, false),
              nokVotes: serializeUSDCFor(archivedProposalsList[i].nokVotes, false),
